  ...
  return (
    <div className="bg-[#F5F5F7] border-b border-black/[0.06] py-1.5 select-none no-print transition-all w-full">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4">
        {/* Government of India & Hackathon Logos Strip - Strictly Equal Height Bounding Boxes */}
        <div className="flex items-center gap-3 sm:gap-4 shrink-0 overflow-x-auto no-scrollbar py-0.5">
          ...
          <div className="h-4 w-px bg-black/[0.12] shrink-0" />
          ...
          <div className="flex items-center h-6 sm:h-7 shrink-0">
            <img
              ...
              className="h-5 sm:h-6 max-h-6 w-auto object-contain mix-blend-multiply block"
            />
          </div>
