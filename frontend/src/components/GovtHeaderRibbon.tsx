...
export const GovtHeaderRibbon: React.FC = () => {
  return (
    <div className="bg-white border-b border-zinc-200 py-2 select-none no-print transition-all w-full">
      <div className="w-full max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-10 xl:px-14 flex flex-col sm:flex-row items-center justify-between gap-3">
        {/* Government of India & Hackathon Logos Strip */}
        <div className="flex items-center gap-3 sm:gap-4.5 overflow-x-auto no-scrollbar py-0.5 max-w-full">
