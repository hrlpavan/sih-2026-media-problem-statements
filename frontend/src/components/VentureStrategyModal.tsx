...
export const VentureStrategyModal: React.FC<VentureStrategyModalProps> = ({ isOpen, onClose }) => {
  ...
  return createPortal(
    ...
    >
      ...
      {/* Modal Container */}
      <div 
        className="w-full max-w-4xl bg-white rounded-[24px] sm:rounded-[28px] border border-black/10 shadow-2xl overflow-hidden text-left flex flex-col max-h-[85vh] relative animate-in fade-in zoom-in-95 duration-150 my-auto"
