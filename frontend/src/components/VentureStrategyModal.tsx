...
export const VentureStrategyModal: React.FC<VentureStrategyModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-md flex items-center justify-center p-4 sm:p-6 animate-in fade-in duration-200">
      <div className="bg-white rounded-[28px] border border-black/10 shadow-2xl max-w-4xl w-full max-h-[90vh] flex flex-col overflow-hidden">
        {/* Modal Header */}
        <div className="p-6 border-b border-zinc-100 flex items-center justify-between">
          <div>
            <div className="flex items-center gap-2">
              <span className="text-[11px] font-bold uppercase tracking-wider text-hrl-crimson bg-hrl-crimson-tint px-2.5 py-0.5 rounded-full">
                HRL INTERNATIONAL™ VENTURE ARCHITECTURE
              </span>
              <span className="text-xs text-zinc-400">·</span>
              <span className="text-xs text-zinc-500 font-mono">PS ID: 26154 // NTRO</span>
            </div>
            <h2 className="text-xl font-bold text-[#1D1D1F] tracking-tight mt-1">
        ...
        {/* Navigation Tabs */}
        <div className="px-6 pt-4 pb-2 border-b border-zinc-100 bg-[#F9F9FB] flex items-center gap-2 overflow-x-auto">
          <button
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
                <div className="p-4 rounded-2xl bg-[#F9F9FB] border border-black/5">
                  <span className="text-xs font-bold text-zinc-500 uppercase tracking-wider block">PRE-SEED CAPITAL</span>
                  <span className="text-2xl font-extrabold text-[#1D1D1F] block mt-1">₹50 Lakhs</span>
                  <span className="text-[11px] text-zinc-500 block mt-0.5">Bootstrap + Grants</span>
                </div>
                <div className="p-4 rounded-2xl bg-[#F9F9FB] border border-black/5">
                  <span className="text-xs font-bold text-zinc-500 uppercase tracking-wider block">SERIES A TARGET</span>
                  <span className="text-2xl font-extrabold text-hrl-crimson block mt-1">₹15 Cr</span>
                  <span className="text-[11px] text-zinc-500 block mt-0.5">@ ₹75 Cr Valuation</span>
                </div>
                <div className="p-4 rounded-2xl bg-[#F9F9FB] border border-black/5">
                  <span className="text-xs font-bold text-zinc-500 uppercase tracking-wider block">NET BURN RATE</span>
                  <span className="text-2xl font-extrabold text-[#1D1D1F] block mt-1">₹1.8L / mo</span>
                  <span className="text-[11px] text-zinc-500 block mt-0.5">High Capital Efficiency</span>
                </div>
                <div className="p-4 rounded-2xl bg-[#F9F9FB] border border-black/5">
                  <span className="text-xs font-bold text-zinc-500 uppercase tracking-wider block">TOTAL RUNWAY</span>
                  <span className="text-2xl font-extrabold text-emerald-600 block mt-1">18 Months</span>
                  <span className="text-[11px] text-zinc-500 block mt-0.5">Zero Debt Structure</span>
                </div>
              </div>

              {/* 4 Cards Grid */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-5 rounded-2xl border border-black/5 bg-[#F9F9FB] space-y-2">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                <div className="p-5 rounded-2xl bg-zinc-900 text-white">
                  ...
                  <span className="text-3xl font-extrabold text-white block mt-1">$18.4 Billion</span>
                  <span className="text-xs text-zinc-400 block mt-1">Global GovTech & Document AI</span>
                </div>
                <div className="p-5 rounded-2xl bg-[#F9F9FB] border border-black/5">
                  <span className="text-xs font-bold text-zinc-500 uppercase tracking-wider block">SAM (INDIA & APAC)</span>
                  <span className="text-3xl font-extrabold text-[#1D1D1F] block mt-1">$3.2 Billion</span>
                  <span className="text-xs text-zinc-500 block mt-1">Defense, PSUs & Regulated BFSI</span>
                </div>
                <div className="p-5 rounded-2xl bg-hrl-crimson-tint border border-hrl-crimson/20">
                  <span className="text-xs font-bold text-hrl-crimson uppercase tracking-wider block">SOM (36-MONTH TARGET)</span>
                  <span className="text-3xl font-extrabold text-hrl-crimson block mt-1">₹700 Cr ($85M)</span>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-5 rounded-2xl bg-[#F9F9FB] border border-black/5 space-y-2">
                  <span className="text-[10px] font-bold text-hrl-crimson uppercase tracking-wider bg-hrl-crimson-tint px-2.5 py-0.5 rounded-full">
                ...
                <div className="p-5 rounded-2xl bg-[#F9F9FB] border border-black/5 space-y-2">
                  <span className="text-[10px] font-bold text-hrl-blue uppercase tracking-wider bg-hrl-blue-light px-2.5 py-0.5 rounded-full">
