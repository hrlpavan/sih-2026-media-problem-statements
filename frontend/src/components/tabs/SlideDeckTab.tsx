...
export const SlideDeckTab: React.FC<SlideDeckTabProps> = ({ slides }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 pb-3 border-b border-zinc-200 no-print">
        <div>
          <span className="text-xs font-bold text-orange-700 bg-orange-50 px-2.5 py-1 rounded-md border border-orange-200">
            Format 2: Meeting Presentation Deck
          </span>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-3.5 py-2 rounded-lg bg-zinc-100 hover:bg-zinc-200 text-zinc-800 font-bold text-xs border border-zinc-300 transition-all flex items-center gap-1.5 cursor-pointer"
          >
          ...
          <a
            ...
            className="px-3.5 py-2 rounded-lg bg-zinc-900 hover:bg-black text-white font-bold text-xs transition-all flex items-center gap-1.5 shadow-sm"
          >
      ...
      <div className={`relative bg-white rounded-2xl border-2 border-zinc-300 shadow-md overflow-hidden transition-all ${
        ...
        <div className="my-auto py-4">
          ...
          {slide.subtitle && (
            <p className="text-xs sm:text-sm font-semibold text-orange-600 mb-6">
              {slide.subtitle}
            </p>
          )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center mt-4">
            ...
            {slide.keyMetric && (
              <div className="p-6 rounded-xl bg-orange-50/60 border border-orange-200 text-center flex flex-col items-center justify-center">
                <span className="text-3xl sm:text-4xl font-extrabold text-zinc-900 tracking-tight">
                  {slide.keyMetric.value}
                </span>
                <span className="text-xs font-bold text-orange-700 uppercase tracking-wider mt-1">
      ...
      <div className="flex items-center justify-between no-print">
        <button
          ...
          className="px-4 py-2 rounded-lg bg-white border border-zinc-300 hover:bg-zinc-50 text-zinc-800 font-bold text-xs shadow-sm disabled:opacity-40 disabled:pointer-events-none transition-all flex items-center gap-1 cursor-pointer"
        >
