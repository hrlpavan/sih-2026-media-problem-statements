...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-zinc-950 text-white border-t border-zinc-800 mt-20 no-print">
      {/* Top Banner Bar */}
      <div className="border-b border-zinc-800/80 py-5 bg-black/40">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs font-semibold text-zinc-300">
              HRL International · Smart India Hackathon 2026 Submission
            </span>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-xs text-zinc-400">
              <li>Problem ID: <strong className="text-white">26154</strong></li>
              <li>Organization: <strong className="text-white">NTRO (Govt. of India)</strong></li>
              <li>Category: <strong className="text-white">Software / AI & Cyber Security</strong></li>
              <li>Team Name: <strong className="text-white">HRL (ID: 104580)</strong></li>
            </ul>
          </div>
        ...
        <div className="mt-8 pt-6 border-t border-zinc-800/80 flex flex-col sm:flex-row items-center justify-between text-xs text-zinc-500">
          <span>© 2026 HRL International · All rights reserved</span>
          <span>Single-Pass Multi-Format AI Pipeline · Sovereign Local Model</span>
        </div>
      </div>
    </footer>
  );
