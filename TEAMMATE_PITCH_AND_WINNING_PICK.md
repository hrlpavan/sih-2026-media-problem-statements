...
* **Organization / Ministry**: **National Technical Research Organisation (NTRO)** *(Prime Technical Intelligence Agency of India)*
* **Category**: **Software**
* **Theme**: **Blockchain & Cybersecurity / AI**
...
4. **Visual "Wow Factor"**: While other teams show boring text tables, your team shows **instant slide decks, infographics, and voice podcasts**.
...
1. A **1-page Executive Summary** for the Minister or Director.
2. A **PowerPoint Presentation Deck** for meetings.
3. An **Infographic / Social Media Poster** for the public.
4. A **Press Release** for journalists.
5. An **Audio Briefing** for busy officers who are traveling.
...
In our tool:
* Every single bullet point has a clickable **[Page 4, Para 2]** badge.
* Clicking the badge opens the original PDF and **highlights the exact sentence** where the fact came from.
* This proves to the judges that our tool is **100% trustworthy and enterprise-ready**.
...
| :--- | :--- | :--- |
| **Member 1 (Lead / Pavan)** | **Product Lead & Pitch** | Master integration, design system, live jury demo flow, and Apple-grade UI polishing. |
| **Member 2** | **Frontend Engineer** | Build the clean dashboard (Next.js / React), file upload dropzone, and multi-format preview tabs. |
| **Member 3** | **Backend & PDF Ingestion** | Build FastAPI server, PyMuPDF document parser, chunking, and source citation coordinate extraction. |
| **Member 4** | **LLM & Prompt Pipeline** | LangChain / LlamaIndex pipeline for structured extraction (Executive Brief, Slide Outline, Press Release). |
| **Member 5** | **Visual & Slide Generator** | Auto-render HTML-to-Image canvas for infographics and HTML/Marp for instant slide presentations. |
| **Member 6** | **Voice AI & Translation** | TTS audio podcast generator (ElevenLabs / Piper) + Regional Language translation (IndicBERT/Bhashini). |
...
* **2:00 - 2:30**: Click a citation badge to show the instant PDF source highlight (Anti-hallucination defense).
* **2:30 - 3:00**: Play the 30-second AI Voice Podcast briefing. Show sovereign on-prem air-gapped readiness.
